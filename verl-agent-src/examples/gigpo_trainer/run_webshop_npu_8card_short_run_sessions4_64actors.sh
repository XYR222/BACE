...
# train: 16 * 8 / 4 = 32 physical actors
# val:   128 / 4    = 32 physical actors
# total:                 64 physical actors
export TRAIN_DATA_SIZE=16
export VAL_DATA_SIZE=128
export GROUP_SIZE=8
export WEBSHOP_SESSIONS_PER_ACTOR=4

# Keep shared search and all non-packing settings identical to the SPA=8 and
# SPA=2 short runs.
...
export GIGPO_RUN_NAME=${GIGPO_RUN_NAME:-gigpo_webshop_npu_8card_short_spa4_64actors_${run_timestamp}}
export RESUME_MODE=${RESUME_MODE:-disable}

printf '%s\n' \
    'WebShop short-run topology:' \
    '  train logical sessions: 128 -> physical actors: 32' \
    '  val logical sessions:   128 -> physical actors: 32' \
    '  total physical environment actors: 64' \
