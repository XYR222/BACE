...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def load_checkpoint(self, local_path: str, hdfs_path: str = None, del_local_after_load=False):
        ...
        # The manager is recreated for every Slurm segment.  Seed its normal
        # retention bookkeeping from the successfully loaded checkpoint so
        # the next save rotates actor shards left by the previous process.
        self.previous_saved_paths = find_existing_component_checkpoints(
            local_path
        )
